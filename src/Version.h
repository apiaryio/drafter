...
#define DRAFTER_PRE_RELEASE_VERSION 4
...
#define DRAFTER_VERSION_STRING_HELPER                                                                                  \
    "v" DRAFTER_STRINGIFY(DRAFTER_MAJOR_VERSION) "." DRAFTER_STRINGIFY(DRAFTER_MINOR_VERSION) "." DRAFTER_STRINGIFY(   \
        DRAFTER_PATCH_VERSION)

#if DRAFTER_VERSION_IS_RELEASE
#define DRAFTER_VERSION_STRING DRAFTER_VERSION_STRING_HELPER
#else
#define DRAFTER_VERSION_STRING DRAFTER_VERSION_STRING_HELPER "-pre." DRAFTER_STRINGIFY(DRAFTER_PRE_RELEASE_VERSION)
#endif
