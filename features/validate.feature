Feature: Validate a blueprint
  ...
  Scenario: Validate a valid blueprint file
    ...
    When I run `drafter --validate blueprint.apib`
  ...
  Scenario: Validate a valid blueprint input
    ...
    When I run `drafter --validate` interactively
  ...
  Scenario: Validate an invalid blueprint file
    ...
    When I run `drafter --validate invalid_blueprint.apib`
    Then the output should contain:
    """
    OK.
  ...
  Scenario: Validate an invalid blueprint file and show report by line number
    ...
    When I run `drafter --validate invalid_blueprint.apib --use-line-num`
    Then the output should contain:
    """
    OK.
    warning: (5)  unexpected header block, expected a group, resource or an action definition, e.g. '# Group <name>', '# <resource name> [<URI>]' or '# <HTTP method> <URI>'; line 4, column 0 - line 4, column 28
    """
