...
# LIBDRAFTER
    {
      ...
      "sources": [
        ...
        "src/apib2apie/CollectionToApie.cc",
        "src/apib2apie/CollectionToApie.h",
        "src/apib2apie/LiteralToApie.cc",
        "src/apib2apie/LiteralToApie.h",
        ...
        "src/apib2apie/PrimitiveToApie.cc",
        "src/apib2apie/PrimitiveToApie.h",
        "src/apib2apie/SourceMapToApie.cc",
        "src/apib2apie/SourceMapToApie.h",
      ],
      "dependencies": [
        "libsnowcrash",
      ],
